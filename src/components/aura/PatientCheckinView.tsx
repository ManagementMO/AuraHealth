      ...
      try {
        ...
        if (error instanceof Error) {
          if (
            ...
            instructions =
              "Please connect a camera and microphone device and refresh the page.";
          } else if (
            ...
            instructions =
              "Please close other applications using the camera/microphone and try again.";
          }
        }
  ...
  useEffect(() => {
    if (
      ...
      toast.success("Conversation started", {
        description:
          "The AI doctor is ready to chat with you. Speak naturally about how you've been feeling.",
        duration: 4000,
      });
    }
            ...
            <div className="text-center mb-8 px-4">
              <div className="bg-blue-50 border border-blue-100 rounded-lg p-6 max-w-2xl mx-auto">
                ...
                <p className="text-neutral-600 text-sm mb-3">
                  Have a natural conversation with our AI doctor to prepare for
                  your real appointment. The AI will respond to you just like a
                  real doctor would.
                </p>
                <div className="bg-blue-100 rounded-lg p-3 text-xs text-blue-800">
                  <strong>What happens:</strong> You&apos;ll have a 60-second
                  conversation with the AI doctor. After the session,
                  you&apos;ll get emotional insights and tips to improve your
                  real doctor visit.
                </div>
              </div>
            </div>
              ...
              {webcamError ? (
                <div className="w-full max-w-md bg-red-50 border border-red-200 rounded-lg p-6 text-center">
                  ...
                  <div className="text-red-500 text-sm mb-4">
                    Both camera and microphone access are required for the
                    practice session.
                  </div>
                  <Button
              ...
              <div className="text-center mb-8 px-4">
                <div className="bg-blue-50 border border-blue-100 rounded-lg p-6 max-w-2xl mx-auto">
                  ...
                  <p className="text-neutral-600 text-sm">
                    Your camera and microphone are set up. Click below to start
                    your 60-second practice session.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center space-y-4">
                <div className="w-full max-w-md">
                  ...
                  <div className="text-center mt-4">
                    <p className="text-neutral-600 text-sm">
                      Camera and microphone ready. You can see yourself just
                      like in a video call with your doctor.
                    </p>
                  </div>
                </div>
          ...
          <div className="text-center space-y-6">
            <div className="bg-green-50 border border-green-100 rounded-lg p-8 max-w-md mx-auto">
              ...
              <p className="text-neutral-600 text-sm mt-4">
                Below you&apos;ll find emotional insights and tips to improve
                your real doctor consultation.
              </p>
            </div>

            <div className="bg-blue-50 border border-blue-100 rounded-lg p-6 max-w-md mx-auto">
              <h4 className="font-semibold text-blue-900 mb-2">
                🎯 Tips for Your Real Doctor Visit
              </h4>
